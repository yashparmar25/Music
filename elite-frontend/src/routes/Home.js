...
const Home = () => {
    return (
        <div className="h-full w-full flex">
            ...
            <div className="h-full fixed w-4/5 bg-black overflow-auto">
                <div className="navbar w-full bg-black h-1/10 bg-black bg-opacity-30 flex items-center justify-end">
                    <div className="w-1/2 fixed flex h-full">
